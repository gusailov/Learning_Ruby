class Railroad
  ...
  def move_train_route_forward
    ...
    train.route ? train.go_next_station : (puts 'Сначала нужно назначить маршрут поезду')
  end

  def move_train_route_back
    train = train_from_list

    train.route ? train.go_previous_station : (puts 'Сначала нужно назначить маршрут поезду')
  end
